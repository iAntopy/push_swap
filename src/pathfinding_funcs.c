...
/*   Updated: 2022/10/24 23:39:21 by iamongeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_tec	*tec_seek_nearest_neighbors(t_tec *tec, t_tec tecs[2], int depth)
{
	...
	ft_printf("RECC : seek nearest : entered \n");
	while (tec->ts->len > 5)
	{
		ft_printf("RECC : wow\n");
